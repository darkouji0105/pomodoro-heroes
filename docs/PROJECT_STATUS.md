...
> - ⚠⚠ **GAME_DESIGN.md のパッシブの記述（5-2 の表・273/283/830行）は決定と食い違っている。** ⚠ このファイルの冒頭の「食い違ったら GAME_DESIGN が正」を**この件には当てはめないこと**（⚠ 人間の決定 2026-09-14 が新しい）
...
- **宿題78** … GAME_DESIGN.md のパッシブの記述（5-2 の表・273/283/830行）を「総ポイント 20/40/60/80/100 で自動解放」に合わせる（⚠ 第1層なので人間の許可が要る）
