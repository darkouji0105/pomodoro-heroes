...
# --- たいまつとフロア内ショップ（段階14-e・PLAN_SCENARIO_MAP.md §5） ---
#
...
## ⚠ 配列の長さがそのまま上限グレード（メモ「上限グレードあり」）。
## grade 0 が基礎のたいまつ。1 なら「次の層だけ見える」。
@export var floor_torch_reveal_layers: Array[int] = [1, 2, 3, 5]
